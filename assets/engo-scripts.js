...
jQuery(document).ready(function($) {
  ...
  $('.js-click-all-departments2').on('click', function() {
    $(this).toggleClass('active');
    $('.js-wrap-all-departments2').toggleClass('has-open');
  });
...
jQuery(document).ready(function($) {
  ...
  function brandv_menu(){
    $('.slick_brand_menu').slick({
      dots: false,
      arrows:false,
      infinite: true,
      speed: 300,
...
jQuery(document).ready(function($) {
  ...
  function jsmenuiconh2(){
    $('.js_icon_horizon-menu2').on( 'click', function() {
      $(this).parents().addClass('active');
    });
    $('.js-back2').on( 'click', function() {
      $(this).parents().parents().find('.content_menu_categories').removeClass('active');
      $(this).parents().parents().find('.menu-horizon-list').removeClass('active');
    });       
  }
  ...
  function menu_category() {
    $('.more-wrap').on('click', function() {
      ...
      $('li.level-0:nth-child(8)').toggleClass('show');
      $('li.level-0:nth-child(9)').toggleClass('show');
      $('li.level-0:nth-child(10)').toggleClass('show');
  ...
  function menucategories() {
    $('.menucategories').on('click', function() {
      $(this).toggleClass('active');
      $('.box_menucategories').toggleClass('active');     
      $('.box_contentmenu_background').toggleClass('active');   
      $('body').addClass('activemenu_mobile')      
    });
    $('.box_contentmenu_background').on('click', function() {
      $(this).removeClass('active');
      $('.box_menucategories').removeClass('active');
  ...
  function jsmenu_fullwidth(){
    ...
    $('.js-full-width').css({'top' : top.top + height - 1 ,'position' : 'fixed' , 'left' :' 0' , 'right' : '0', 'width' : '100%' })

    $(window).scroll(function() {
      var height = $('.js_height_hd').outerHeight();
      if ($(window).scrollTop() >= height){      
        $('.js-full-width').css({'top' : height - 1 })
      }
      else{
        $('.js-full-width').css({'top' : top.top + height - 1  })
      }     
    });
  }
  ...
  promo();
      ...
      $(window).scroll(function() {
        if ($(window).scrollTop() > 300) {
          btn_top.addClass('button-show');
        } else {
          btn_top.removeClass('button-show');
        }
      });
