      ...
      if (sale || pre_order || sold_out) {
        ...
        if (sale) {
          if (label.querySelector(".tps__sale-label")) {
            label.querySelector(".tps__sale-label").innerText = -percent.toFixed(0) + "%";
          }else{
        ...
        if (sold_out) {
          if (label.querySelector(".tps__sold-out-label")) {
            label.querySelector(".tps__sold-out-label").innerText = window.variantStrings.soldOut;
          }else{
      ...
      fetch(url)
        ...
        .then((text) => {
          ...
          if (productRecommendationsSection.querySelector(".tps__swiper")) {
            TpsSettingsSwiper.TpsCarousel(productRecommendationsSection.querySelector(".tps__swiper"));
          }
        })
        .catch((e) => {
          console.error(e);
        ...
        .then((state) => {
          ...
          miniCart.getSectionsToRender().forEach((section) => {
            ...
            if (cart_threshold) {
              ...
              if (cart_threshold.querySelector(".tps__cart-thres") && html.querySelector(".tps__cart-thres")) {
        ...
        if (wishlist_items === null) {
          ...
          if (index === -1) {
            ...
            if (is_page_wishlist) {
              ...
              const it = is_page_wishlist.querySelectorAll(".tps__product-item");
...
var TpsSubActionProduct = (function () {
  return {
    ...
    handleInitWishlist: function () {
      ...
      const wishlist_icon = document.querySelectorAll(".tps__product-wishlist");
      wishlist_icon.forEach((e) => {
        const { proAddWishlist, proRemoveWishlist } = e?.dataset;
        const is_page_wishlist = document.querySelector(
          ".tps__wishlist-page-section"
        );
        const tooltip_wishlist = e.querySelector(".tps_tooltip-content");
    ...
    handleInitCompare: function () {
      ...
      const compare_icon = document.querySelectorAll(".tp-product-details-action-sm-btn-compare");
      const is_page_compare = document.querySelector(
        ".tps__compare-page-section"
      );
    ...
    handleActionCompare: function () {
      const btnCompare = document.querySelectorAll(".tp-product-details-action-sm-btn-compare-js");
  ...
  return {
    ...
    initVerticalMenu: function () {
      ...
      if (document.querySelector(".tps_vertical_menu .title-menu-dropdown")) {
        document.querySelector(".tps_vertical_menu .title-menu-dropdown")
        .addEventListener("click", (event) => {
          ...
          if (closest.classList.contains("open")) {
            ...
            if (document.querySelector(".tps__overlay")) {
              ...
              document.querySelector(".tps__overlay").classList.remove("d-none-overlay")
            }
          }
        });
      }
...
class CartNotification extends HTMLElement {
  ...
  open() {
    this.notification.classList.add("tps__opend-popup-header");
    document.documentElement.classList.add("hside_opened");
